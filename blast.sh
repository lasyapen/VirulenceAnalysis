...
QUERY="virulence_analysis/concatenated_query.fasta"
...
#convert vfdb_blast_results_tabular.txt into a file called "annotated_blast_result.txt" that contains the full MAG name as column 1 (including the k141 part of the header)
